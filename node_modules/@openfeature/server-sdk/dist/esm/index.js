...
var MultiProvider = class _MultiProvider {
  ...
  initialize(context, domain) {
    return __async(this, null, function* () {
      const result = yield Promise.allSettled(
        this.providerEntries.map((provider) => {
          var _a, _b;
          return (_b = (_a = provider.provider).initialize) == null ? void 0 : _b.call(_a, context, domain);
        })
      );
...
// src/open-feature.ts
var GLOBAL_OPENFEATURE_API_KEY = /* @__PURE__ */ Symbol.for("@openfeature/js-sdk/api");
